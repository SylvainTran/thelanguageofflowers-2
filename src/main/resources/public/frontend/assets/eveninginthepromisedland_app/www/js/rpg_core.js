...
Graphics._createCanvas = function() {
    /**
     * TODO: Make it appear in the Angular tree
     */
    this._canvas = document.getElementById('GameCanvas');//document.createElement('canvas');
...
Graphics._createVideo = function() {
    this._video = document.getElementById('GameVideo'); //document.createElement('video');
...
Graphics._createUpperCanvas = function() {
    this._upperCanvas = document.getElementById('UpperCanvas');//document.createElement('canvas');
