...
DataManager.loadDataFile = function(name, src) {
    ...
    var url = 'assets/eveninginthepromisedland_app/www/data/' + src;
    xhr.open('GET', url);
...
ImageManager.loadAnimation = function(filename, hue) {
    return this.loadBitmap('assets/eveninginthepromisedland_app/www/img/animations/', filename, hue, true);
};

ImageManager.loadBattleback1 = function(filename, hue) {
    return this.loadBitmap('assets/eveninginthepromisedland_app/www/img/battlebacks1/', filename, hue, true);
};

ImageManager.loadBattleback2 = function(filename, hue) {
    return this.loadBitmap('assets/eveninginthepromisedland_app/www/img/battlebacks2/', filename, hue, true);
};

ImageManager.loadEnemy = function(filename, hue) {
    return this.loadBitmap('assets/eveninginthepromisedland_app/www/img/enemies/', filename, hue, true);
};

ImageManager.loadCharacter = function(filename, hue) {
    return this.loadBitmap('assets/eveninginthepromisedland_app/www/img/characters/', filename, hue, false);
};

ImageManager.loadFace = function(filename, hue) {
    return this.loadBitmap('assets/eveninginthepromisedland_app/www/img/faces/', filename, hue, true);
};

ImageManager.loadParallax = function(filename, hue) {
    return this.loadBitmap('assets/eveninginthepromisedland_app/www/img/parallaxes/', filename, hue, true);
};

ImageManager.loadPicture = function(filename, hue) {
    return this.loadBitmap('assets/eveninginthepromisedland_app/www/img/pictures/', filename, hue, true);
};

ImageManager.loadSvActor = function(filename, hue) {
    return this.loadBitmap('assets/eveninginthepromisedland_app/www/img/sv_actors/', filename, hue, false);
};

ImageManager.loadSvEnemy = function(filename, hue) {
    return this.loadBitmap('assets/eveninginthepromisedland_app/www/img/sv_enemies/', filename, hue, true);
};

ImageManager.loadSystem = function(filename, hue) {
    return this.loadBitmap('assets/eveninginthepromisedland_app/www/img/system/', filename, hue, false);
};

ImageManager.loadTileset = function(filename, hue) {
    return this.loadBitmap('assets/eveninginthepromisedland_app/www/img/tilesets/', filename, hue, false);
};

ImageManager.loadTitle1 = function(filename, hue) {
    return this.loadBitmap('assets/eveninginthepromisedland_app/www/img/titles1/', filename, hue, true);
};

ImageManager.loadTitle2 = function(filename, hue) {
    return this.loadBitmap('assets/eveninginthepromisedland_app/www/img/titles2/', filename, hue, true);
};
...
ImageManager.reserveAnimation = function(filename, hue, reservationId) {
    return this.reserveBitmap('assets/eveninginthepromisedland_app/www/img/animations/', filename, hue, true, reservationId);
};

ImageManager.reserveBattleback1 = function(filename, hue, reservationId) {
    return this.reserveBitmap('assets/eveninginthepromisedland_app/www/img/battlebacks1/', filename, hue, true, reservationId);
};

ImageManager.reserveBattleback2 = function(filename, hue, reservationId) {
    return this.reserveBitmap('assets/eveninginthepromisedland_app/www/img/battlebacks2/', filename, hue, true, reservationId);
};

ImageManager.reserveEnemy = function(filename, hue, reservationId) {
    return this.reserveBitmap('assets/eveninginthepromisedland_app/www/img/enemies/', filename, hue, true, reservationId);
};

ImageManager.reserveCharacter = function(filename, hue, reservationId) {
    return this.reserveBitmap('assets/eveninginthepromisedland_app/www/img/characters/', filename, hue, false, reservationId);
};

ImageManager.reserveFace = function(filename, hue, reservationId) {
    return this.reserveBitmap('assets/eveninginthepromisedland_app/www/img/faces/', filename, hue, true, reservationId);
};

ImageManager.reserveParallax = function(filename, hue, reservationId) {
    return this.reserveBitmap('assets/eveninginthepromisedland_app/www/img/parallaxes/', filename, hue, true, reservationId);
};

ImageManager.reservePicture = function(filename, hue, reservationId) {
    return this.reserveBitmap('assets/eveninginthepromisedland_app/www/img/pictures/', filename, hue, true, reservationId);
};

ImageManager.reserveSvActor = function(filename, hue, reservationId) {
    return this.reserveBitmap('assets/eveninginthepromisedland_app/www/img/sv_actors/', filename, hue, false, reservationId);
};

ImageManager.reserveSvEnemy = function(filename, hue, reservationId) {
    return this.reserveBitmap('assets/eveninginthepromisedland_app/www/img/sv_enemies/', filename, hue, true, reservationId);
};

ImageManager.reserveSystem = function(filename, hue, reservationId) {
    return this.reserveBitmap('assets/eveninginthepromisedland_app/www/img/system/', filename, hue, false, reservationId || this._systemReservationId);
};

ImageManager.reserveTileset = function(filename, hue, reservationId) {
    return this.reserveBitmap('assets/eveninginthepromisedland_app/www/img/tilesets/', filename, hue, false, reservationId);
};

ImageManager.reserveTitle1 = function(filename, hue, reservationId) {
    return this.reserveBitmap('assets/eveninginthepromisedland_app/www/img/titles1/', filename, hue, true, reservationId);
};

ImageManager.reserveTitle2 = function(filename, hue, reservationId) {
    return this.reserveBitmap('assets/eveninginthepromisedland_app/www/img/titles2/', filename, hue, true, reservationId);
};
...
AudioManager.createBuffer = function(folder, name) {
    var ext = this.audioFileExt();
    var url = "assets/eveninginthepromisedland_app/www/" + this._path + folder + '/' + encodeURIComponent(name) + ext;
...
SceneManager.initGraphics = function() {
    ...
    Graphics.setLoadingImage('assets/eveninginthepromisedland_app/www/img/system/Loading.png');
...
PluginManager._path         = 'assets/eveninginthepromisedland_app/www/js/plugins/';
